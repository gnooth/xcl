...
DEFINE_SYMBOL(_debug_level_, PACKAGE_EXT, "*DEBUG-LEVEL*");
...
DEFINE_SYMBOL(bignum_widetag, PACKAGE_SYS, "+BIGNUM-WIDETAG+");
...
DEFINE_SYMBOL(debug_level, PACKAGE_SYS, "DEBUG-LEVEL");
...
DEFINE_SYMBOL(error_bad_index_for_vector, PACKAGE_SYS, "ERROR-BAD-INDEX-FOR-VECTOR");
DEFINE_SYMBOL(error_integer_bounds, PACKAGE_SYS, "ERROR-INTEGER-BOUNDS");
DEFINE_SYMBOL(error_not_bit, PACKAGE_SYS, "ERROR-NOT-BIT");
DEFINE_SYMBOL(error_not_cons, PACKAGE_SYS, "ERROR-NOT-CONS");
DEFINE_SYMBOL(error_not_fixnum, PACKAGE_SYS, "ERROR-NOT-FIXNUM");
DEFINE_SYMBOL(error_not_function, PACKAGE_SYS, "ERROR-NOT-FUNCTION");
DEFINE_SYMBOL(error_not_hash_table, PACKAGE_SYS, "ERROR-NOT-HASH-TABLE");
DEFINE_SYMBOL(error_not_integer, PACKAGE_SYS, "ERROR-NOT-INTEGER");
DEFINE_SYMBOL(error_not_list, PACKAGE_SYS, "ERROR-NOT-LIST");
DEFINE_SYMBOL(error_not_number, PACKAGE_SYS, "ERROR-NOT-NUMBER");
...
DEFINE_SYMBOL(error_not_string, PACKAGE_SYS, "ERROR-NOT-STRING");
DEFINE_SYMBOL(error_not_symbol, PACKAGE_SYS, "ERROR-NOT-SYMBOL");
DEFINE_SYMBOL(error_not_type, PACKAGE_SYS, "ERROR-NOT-TYPE");
DEFINE_SYMBOL(error_not_vector, PACKAGE_SYS, "ERROR-NOT-VECTOR");
DEFINE_SYMBOL(error_wrong_number_of_arguments, PACKAGE_SYS, "ERROR-WRONG-NUMBER-OF-ARGUMENTS");
...
DEFINE_SYMBOL(hash_table_widetag, PACKAGE_SYS, "+HASH-TABLE-WIDETAG+");
...
DEFINE_SYMBOL(put3, PACKAGE_SYS, "PUT3");
...
DEFINE_SYMBOL(rdtsc, PACKAGE_SYS, "RDTSC");
...
DEFINE_SYMBOL(set_source, PACKAGE_SYS, "SET-SOURCE");
...
DEFINE_SYMBOL(source, PACKAGE_SYS, "SOURCE");
DEFINE_SYMBOL(source_file_position, PACKAGE_SYS, "SOURCE-FILE-POSITION");
DEFINE_SYMBOL(source_pathname, PACKAGE_SYS, "SOURCE-PATHNAME");
...
DEFINE_SYMBOL(thread_statistics, PACKAGE_SYS, "THREAD-STATISTICS");
...
DEFINE_SYMBOL(two_arg_string_equals, PACKAGE_SYS, "TWO-ARG-STRING=");
...
DEFINE_SYMBOL(warn_on_redefinition, PACKAGE_SYS, "*WARN-ON-REDEFINITION*");
DEFINE_SYMBOL(whitespacep, PACKAGE_SYS, "WHITESPACEP");
DEFINE_SYMBOL(widetag_function_bit, PACKAGE_SYS, "+WIDETAG-FUNCTION-BIT+");
DEFINE_SYMBOL(widetag_number_bit, PACKAGE_SYS, "+WIDETAG-NUMBER-BIT+");
DEFINE_SYMBOL(widetag_offset, PACKAGE_SYS, "+WIDETAG-OFFSET+");
DEFINE_SYMBOL(widetag_simple_array_bit, PACKAGE_SYS, "+WIDETAG-SIMPLE-ARRAY-BIT+");
DEFINE_SYMBOL(widetag_simple_string_bit, PACKAGE_SYS, "+WIDETAG-SIMPLE-STRING-BIT+");
DEFINE_SYMBOL(widetag_stream_bit, PACKAGE_SYS, "+WIDETAG-STREAM-BIT+");
DEFINE_SYMBOL(widetag_string_bit, PACKAGE_SYS, "+WIDETAG-STRING-BIT+");
...
DEFINE_SYMBOL(xcpuid, PACKAGE_SYS, "%CPUID");

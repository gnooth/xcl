...
const long WIDETAG_ANSI_STREAM_BIT              = 4096;
...
const long WIDETAG_ANSI_STREAM                  = WIDETAG_ANSI_STREAM_BIT;
const long WIDETAG_STRING_INPUT_STREAM          = WIDETAG_ANSI_STREAM_BIT +  1;
const long WIDETAG_STRING_OUTPUT_STREAM         = WIDETAG_ANSI_STREAM_BIT +  2;
const long WIDETAG_FILE_STREAM                  = WIDETAG_ANSI_STREAM_BIT +  3;
const long WIDETAG_BROADCAST_STREAM             = WIDETAG_ANSI_STREAM_BIT +  4;
const long WIDETAG_TWO_WAY_STREAM               = WIDETAG_ANSI_STREAM_BIT +  5;
const long WIDETAG_SOCKET_STREAM                = WIDETAG_ANSI_STREAM_BIT +  6;
const long WIDETAG_CONCATENATED_STREAM          = WIDETAG_ANSI_STREAM_BIT +  7;
const long WIDETAG_ECHO_STREAM                  = WIDETAG_ANSI_STREAM_BIT +  8;
const long WIDETAG_SYNONYM_STREAM               = WIDETAG_ANSI_STREAM_BIT +  9;
const long WIDETAG_SLIME_INPUT_STREAM           = WIDETAG_ANSI_STREAM_BIT + 10;
const long WIDETAG_SLIME_OUTPUT_STREAM          = WIDETAG_ANSI_STREAM_BIT + 11;

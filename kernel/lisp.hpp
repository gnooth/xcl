...
const WIDETAG WIDETAG_STRING                       = WIDETAG_VECTOR + 1;
...
const WIDETAG WIDETAG_SIMPLE_STRING                = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 1;
...
const WIDETAG WIDETAG_NIL_VECTOR                   = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 7;

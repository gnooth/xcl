...
// REVIEW
typedef long LOWTAG;
typedef long WIDETAG;

// lowtags
const LOWTAG LOWTAG_EVEN_FIXNUM                    =   0;
const LOWTAG LOWTAG_LIST                           =   1;
const LOWTAG LOWTAG_TYPED_OBJECT                   =   2;
const LOWTAG LOWTAG_ODD_FIXNUM                     =   4;
const LOWTAG LOWTAG_NULL_VALUE                     =   5;
const LOWTAG LOWTAG_CHARACTER                      =   6;
...
const WIDETAG WIDETAG_HASH_TABLE                   =  15;
// const WIDETAG WIDETAG_STREAM                       =  16;
const WIDETAG WIDETAG_SPECIAL_OPERATOR             =  17;
const WIDETAG WIDETAG_THREAD                       =  18;
// const WIDETAG WIDETAG_CONDITION                  =  19;
const WIDETAG WIDETAG_ENVIRONMENT                  =  20;
const WIDETAG WIDETAG_STRUCTURE_OBJECT             =  21;
// const WIDETAG WIDETAG_CLOSURE                      =  22;
// const WIDETAG WIDETAG_AUTOLOAD                     =  23;
// const WIDETAG WIDETAG_MACRO                        =  24;
const WIDETAG WIDETAG_RANDOM_STATE                 =  25;
// const WIDETAG WIDETAG_PRIMITIVE                    =  26;
const WIDETAG WIDETAG_PATHNAME                     =  27;
// const WIDETAG WIDETAG_STRING_INPUT_STREAM          =  28;
// const WIDETAG WIDETAG_STRING_OUTPUT_STREAM         =  29;
// const WIDETAG WIDETAG_BUILT_IN_CLASS             =  30;
// const WIDETAG WIDETAG_STRUCTURE_CLASS            =  31;
// const WIDETAG WIDETAG_STANDARD_CLASS             =  32;
const WIDETAG WIDETAG_SYMBOL_MACRO                 =  33;
const WIDETAG WIDETAG_STRUCTURE_SLOT_DEFINITION    =  34;
// const WIDETAG WIDETAG_FILE_STREAM                  =  35;
// const WIDETAG WIDETAG_STANDARD_GENERIC_FUNCTION  =  36;
const WIDETAG WIDETAG_STANDARD_METHOD              =  37;
// const WIDETAG WIDETAG_COMPILED_CLOSURE             =  38;
const WIDETAG WIDETAG_LAYOUT                       =  39;
// const WIDETAG WIDETAG_STANDARD_OBJECT            =  40;
const WIDETAG WIDETAG_UNBOUND_MARKER               =  41;
// const WIDETAG WIDETAG_BROADCAST_STREAM             =  42;
// const WIDETAG WIDETAG_TWO_WAY_STREAM               =  43;
// const WIDETAG WIDETAG_SOCKET_STREAM                =  44;
const WIDETAG WIDETAG_SERVER_SOCKET                =  45;
// const WIDETAG WIDETAG_CONCATENATED_STREAM          =  46;
// const WIDETAG WIDETAG_ECHO_STREAM                  =  47;
// const WIDETAG WIDETAG_SYNONYM_STREAM               =  48;
const WIDETAG WIDETAG_RESTART                      =  49;
const WIDETAG WIDETAG_READTABLE                    =  50;
// const WIDETAG WIDETAG_COMPILED_FUNCTION            =  51;
const WIDETAG WIDETAG_MUTEX                        =  52;
const WIDETAG WIDETAG_CONDITION_VARIABLE           =  53;
const WIDETAG WIDETAG_LOGICAL_PATHNAME             =  54;
// const WIDETAG WIDETAG_SLIME_INPUT_STREAM           =  55;
// const WIDETAG WIDETAG_SLIME_OUTPUT_STREAM          =  56;

const WIDETAG WIDETAG_ARRAY_BIT                    =    64;
const WIDETAG WIDETAG_SIMPLE_ARRAY_BIT             =   128;
const WIDETAG WIDETAG_VECTOR_BIT                   =   256;
const WIDETAG WIDETAG_INSTANCE_BIT                 =   512;
...
const WIDETAG WIDETAG_STRING_BIT                   = 16384;
const WIDETAG WIDETAG_SIMPLE_STRING_BIT            = 32768;
...
const WIDETAG WIDETAG_ARRAY_T                      = WIDETAG_ARRAY_BIT + 1;
const WIDETAG WIDETAG_SIMPLE_ARRAY_T               = WIDETAG_ARRAY_BIT + WIDETAG_SIMPLE_ARRAY_BIT + 1;

const WIDETAG WIDETAG_VECTOR_T                     = WIDETAG_VECTOR + 2;
const WIDETAG WIDETAG_VECTOR_UB8                   = WIDETAG_VECTOR + 3;
const WIDETAG WIDETAG_VECTOR_UB16                  = WIDETAG_VECTOR + 4;
const WIDETAG WIDETAG_VECTOR_UB32                  = WIDETAG_VECTOR + 5;
const WIDETAG WIDETAG_BIT_VECTOR                   = WIDETAG_VECTOR + 6;

const WIDETAG WIDETAG_SIMPLE_VECTOR                = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 2;
const WIDETAG WIDETAG_SIMPLE_ARRAY_UB8_1           = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 3;
const WIDETAG WIDETAG_SIMPLE_ARRAY_UB16_1          = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 4;
const WIDETAG WIDETAG_SIMPLE_ARRAY_UB32_1          = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 5;
const WIDETAG WIDETAG_SIMPLE_BIT_VECTOR            = WIDETAG_VECTOR + WIDETAG_SIMPLE_ARRAY_BIT + 6;

const WIDETAG WIDETAG_STRING                       = WIDETAG_VECTOR + WIDETAG_STRING_BIT;
const WIDETAG WIDETAG_NIL_VECTOR                   = WIDETAG_STRING + 1;

const WIDETAG WIDETAG_SIMPLE_STRING                = WIDETAG_STRING + WIDETAG_SIMPLE_ARRAY_BIT + WIDETAG_SIMPLE_STRING_BIT;
const WIDETAG WIDETAG_SIMPLE_NIL_VECTOR            = WIDETAG_SIMPLE_STRING + 1;

const WIDETAG WIDETAG_STANDARD_OBJECT              = WIDETAG_INSTANCE_BIT + 1;
const WIDETAG WIDETAG_CONDITION                    = WIDETAG_INSTANCE_BIT + 2;
// const WIDETAG WIDETAG_FUNCALLABLE_STANDARD_OBJECT  = WIDETAG_INSTANCE_BIT + 3;
// const WIDETAG WIDETAG_STANDARD_GENERIC_FUNCTION    = WIDETAG_INSTANCE_BIT + 4;

const WIDETAG WIDETAG_BUILT_IN_CLASS               = WIDETAG_INSTANCE_BIT + WIDETAG_CLASS_BIT + 1;
const WIDETAG WIDETAG_STRUCTURE_CLASS              = WIDETAG_INSTANCE_BIT + WIDETAG_CLASS_BIT + 2;
const WIDETAG WIDETAG_STANDARD_CLASS               = WIDETAG_INSTANCE_BIT + WIDETAG_CLASS_BIT + 3;
const WIDETAG WIDETAG_FUNCALLABLE_STANDARD_CLASS   = WIDETAG_INSTANCE_BIT + WIDETAG_CLASS_BIT + 4;

const WIDETAG WIDETAG_FUNCTION                     = WIDETAG_FUNCTION_BIT + 1;
const WIDETAG WIDETAG_PRIMITIVE                    = WIDETAG_FUNCTION_BIT + 2;
const WIDETAG WIDETAG_CLOSURE                      = WIDETAG_FUNCTION_BIT + 3;
const WIDETAG WIDETAG_AUTOLOAD                     = WIDETAG_FUNCTION_BIT + 4;
const WIDETAG WIDETAG_MACRO                        = WIDETAG_FUNCTION_BIT + 5;
const WIDETAG WIDETAG_FUNCALLABLE_STANDARD_OBJECT  = WIDETAG_FUNCTION_BIT + WIDETAG_INSTANCE_BIT + 6;
const WIDETAG WIDETAG_STANDARD_GENERIC_FUNCTION    = WIDETAG_FUNCTION_BIT + WIDETAG_INSTANCE_BIT + 7;
const WIDETAG WIDETAG_COMPILED_CLOSURE             = WIDETAG_FUNCTION_BIT + 8;
const WIDETAG WIDETAG_COMPILED_FUNCTION            = WIDETAG_FUNCTION_BIT + 9;

const WIDETAG WIDETAG_ANSI_STREAM                  = WIDETAG_ANSI_STREAM_BIT;
const WIDETAG WIDETAG_STRING_INPUT_STREAM          = WIDETAG_ANSI_STREAM_BIT +  1;
const WIDETAG WIDETAG_STRING_OUTPUT_STREAM         = WIDETAG_ANSI_STREAM_BIT +  2;
const WIDETAG WIDETAG_FILE_STREAM                  = WIDETAG_ANSI_STREAM_BIT +  3;
const WIDETAG WIDETAG_BROADCAST_STREAM             = WIDETAG_ANSI_STREAM_BIT +  4;
const WIDETAG WIDETAG_TWO_WAY_STREAM               = WIDETAG_ANSI_STREAM_BIT +  5;
const WIDETAG WIDETAG_SOCKET_STREAM                = WIDETAG_ANSI_STREAM_BIT +  6;
const WIDETAG WIDETAG_CONCATENATED_STREAM          = WIDETAG_ANSI_STREAM_BIT +  7;
const WIDETAG WIDETAG_ECHO_STREAM                  = WIDETAG_ANSI_STREAM_BIT +  8;
const WIDETAG WIDETAG_SYNONYM_STREAM               = WIDETAG_ANSI_STREAM_BIT +  9;
const WIDETAG WIDETAG_SLIME_INPUT_STREAM           = WIDETAG_ANSI_STREAM_BIT + 10;
const WIDETAG WIDETAG_SLIME_OUTPUT_STREAM          = WIDETAG_ANSI_STREAM_BIT + 11;
...
const TYPECODE TYPECODE_ANSI_STREAM               = WIDETAG_ANSI_STREAM;
...
inline unsigned long * __attribute__ ((always_inline)) current_sp()
{
  unsigned long * sp;
#ifdef __x86_64__

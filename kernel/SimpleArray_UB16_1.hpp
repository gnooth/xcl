...
#ifndef __SIMPLEARRAY_UB16_1_HPP
#define __SIMPLEARRAY_UB16_1_HPP
...
inline bool simple_array_ub16_1_p(Value value)
{
  return (typed_object_p(value)
          && the_typed_object(value)->widetag() == WIDETAG_SIMPLE_ARRAY_UB16_1);
}

inline SimpleArray_UB16_1 * the_simple_array_ub16_1(Value value)
{
  assert(simple_array_ub16_1_p(value));
  return reinterpret_cast<SimpleArray_UB16_1 *>(value - LOWTAG_TYPED_OBJECT);
}

inline SimpleArray_UB16_1 * check_simple_array_ub16_1(Value value)
{
  if (simple_array_ub16_1_p(value))
    return the_simple_array_ub16_1(value);
  Value expected_type = list3(S_simple_array, S_unsigned_byte, list1(make_fixnum(16)));
  signal_type_error(value, expected_type);
  // Not reached.
  return NULL;
}

#endif // SimpleArray_UB16_1.hpp

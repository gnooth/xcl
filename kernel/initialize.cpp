...
//   PACKAGE_CL->add_external_symbol(the_symbol(NIL));
  ...
  ADD_PRIMITIVE(S_enable_gc, SYS_enable_gc, 1, 1);
  ...
  ADD_PRIMITIVE(S_error_integer_bounds, SYS_error_integer_bounds, 3, 3);
  ...
  ADD_PRIMITIVE(S_error_not_hash_table, SYS_error_not_hash_table, 1, 1);
  ADD_PRIMITIVE(S_error_not_integer, SYS_error_not_integer, 1, 1);
  ...
  ADD_PRIMITIVE(S_make_simple_bit_vector, SYS_make_simple_bit_vector, 1, 1);
  ...
  ADD_PRIMITIVE(S_require_simple_bit_vector, SYS_require_simple_bit_vector, 1, 1);
  ...
  ADD_PRIMITIVE(S_print_control_frames, SYS_print_control_frames, 0, 0);
  ...
  ADD_PRIMITIVE(S_thread_statistics, SYS_thread_statistics, 0, 0);
  ...
  ADD_PRIMITIVE(S_valid_function_name_p, SYS_valid_function_name_p, 1, 1);
#ifdef __x86_64__

...
extern Value CL_copy_seq(Value arg);
...
extern Value EXT_exit(unsigned int numargs, Value args[]);
...
extern Value EXT_quit(unsigned int numargs, Value args[]);
...
extern Value SYS_ansi_stream_element_type(Value arg);
extern Value SYS_ansi_stream_input_stream_p(Value arg);
...
extern Value SYS_copy_string(Value arg);
...
extern Value SYS_error_integer_bounds(Value datum, Value min, Value max);
...
extern Value SYS_put3(Value symbol, Value indicator, Value new_value);
...
extern Value SYS_require_simple_bit_vector(Value arg);
...
extern Value SYS_set_source(Value arg1, Value arg2);
...
extern Value SYS_source(Value arg);
extern Value SYS_source_file_position(Value arg);
extern Value SYS_source_pathname(Value arg);

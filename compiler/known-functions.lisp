...
(defknown backquotify (t t) (values t t))
...
(defknown find-symbol (*) (values t t))
...
(defknown function-lambda-expression (t) (values t t t))
(defknown functionp (t) boolean (:safe))
(defknown gensym (*) symbol)
(defknown gethash2 (t hash-table) (values t boolean))
(defknown get-properties (*) (values t t t))
(defknown get-setf-expansion (*) (values t t t t t))
(defknown hash-table-count (hash-table) (integer 0 *))
(defknown hash-table-p (t) boolean (:safe))
(defknown integer-decode-float (float) (values integer integer integer))
...
(defknown macroexpand (*) (values t t))
(defknown macroexpand-1 (*) (values t t))
...
(defknown parse-body (*) (values t t t))
(defknown parse-integer (*) (values t t))
...
(defknown verify-keywords (t t) (values t t))

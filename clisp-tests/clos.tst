...
#-(or GCL CMU SBCL OpenMCL LISPWORKS xcl)
(use-package "CLOS")
#-(or GCL CMU SBCL OpenMCL LISPWORKS xcl)
T
...
(eq (class-of (make-array 10 :element-type nil)) (find-class #+CMU 'simple-string #+SBCL 'sb-kernel::simple-array-nil #+xcl 'sys:nil-vector #-(or CMU SBCL xcl) 'string)) T
...
#+abcl
(defun subclassp (class1 class2)
  (sys:subclassp class1 class2))
#+(or CLISP ALLEGRO CMU SBCL OpenMCL LISPWORKS abcl) SUBCLASSP
...
#-(or CLISP GCL ALLEGRO CMU SBCL LISPWORKS xcl) UNKNOWN
...
#+xcl (FOO 2.0 0.0 BAR 1.41421354 0.785398185)
...
#-(or CLISP GCL ALLEGRO CMU SBCL OpenMCL LISPWORKS xcl) UNKNOWN

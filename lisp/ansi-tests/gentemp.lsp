...
#+xcl
;; Autoloading GENTEMP causes the value of *GENSYM-COUNTER* to change. Is this
;; a bug? In any case it's not the bug GENTEMP.1 is looking for...
(when (ext:autoloadp 'gentemp)
  (ext:resolve 'gentemp))

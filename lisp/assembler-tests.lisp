...
(defparameter *tests*
  '(((:push :eax)               #(#x50))
    ...
    ((:xor :eax :eax)           #(#x31 #xc0))
    ((:xor -4 :eax)             #(#x83 #xf0 #xfc))
    ((:or 1 :al)                #(#x0c #x01))
    ((:pop (:eax))              #(#x8f #x00))
    ((:pop (4 :eax))            #(#x8f #x40 #x04))
    ((:push 0)                  #(#x6a #x00))
    ((:push 4)                  #(#x6a #x04))
...
(defparameter *tests*
  '(
    ...
    ((:add :rax :r8)            #(#x49 #x01 #xc0))
    ((:add :rax :r9)            #(#x49 #x01 #xc1))
    ((:add :r8 :rax)            #(#x4c #x01 #xc0))
    ((:add :r8 :r9)             #(#x4d #x01 #xc1))
    ((:add :r9 :r8)             #(#x4d #x01 #xc8))
    ...
    ((:sub :rax :r9)            #(#x49 #x29 #xc1))
    ((:sub :r8 :rax)            #(#x4c #x29 #xc0))
    ((:sub :r8 :r9)             #(#x4d #x29 #xc1))
    ((:sub :r9 :r8)             #(#x4d #x29 #xc8))
    ((:sub 6 :al)               #(#x2c #x06))
    ((:test 3 :al)              #(#xa8 #x03))
    ((:test 3 :dl)              #(#xf6 #xc2 #x03))
    ((:test 3 :cl)              #(#xf6 #xc1 #x03))

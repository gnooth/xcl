...
extern Value CL_rem(Value arg1, Value arg2);
...
extern Value SYS_add_2(Value v1, Value v2);
...
extern Value SYS_defparameter_internal(Value name, Value initial_value);
extern Value SYS_defun_internal(Value name, Value function);
extern Value SYS_defvar_internal(Value arg);
...
extern Value SYS_divide_2(Value v1, Value v2);
...
extern Value SYS_multiply_2(Value v1, Value v2);
...
extern Value SYS_read_8_bits(unsigned int numargs, Value args[]);

...
DEFINE_SYMBOL(copy_string, PACKAGE_EXT, "COPY-STRING");
...
DEFINE_SYMBOL(run_program, PACKAGE_EXT, "RUN-PROGRAM");
...
// SYS
DEFINE_SYMBOL(add_2, PACKAGE_SYS, "TWO-ARG-+");
...
DEFINE_SYMBOL(cl_package, PACKAGE_SYS, "+CL-PACKAGE+");
...
DEFINE_SYMBOL(cons_lowtag, PACKAGE_SYS, "+CONS-LOWTAG+");
...
DEFINE_SYMBOL(divide_2, PACKAGE_SYS, "TWO-ARG-/");
...
DEFINE_SYMBOL(function_code, PACKAGE_SYS, "FUNCTION-CODE");
...
DEFINE_SYMBOL(multiply_2, PACKAGE_SYS, "TWO-ARG-*");
...
DEFINE_SYMBOL(profiler_sample_count, PACKAGE_SYS, "PROFILER-SAMPLE-COUNT");
...
DEFINE_SYMBOL(start_profiler, PACKAGE_SYS, "START-PROFILER");
...
DEFINE_SYMBOL(subtract_2, PACKAGE_SYS, "TWO-ARG--");

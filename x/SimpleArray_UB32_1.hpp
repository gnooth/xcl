...
#ifndef __SIMPLEARRAY_UB32_1_HPP
#define __SIMPLEARRAY_UB32_1_HPP

class SimpleArray_UB32_1 : public AbstractVector
{
private:
...
public:
  ...
  SimpleArray_UB32_1(INDEX capacity)
    : AbstractVector(WIDETAG_SIMPLE_ARRAY_UB32_1, capacity)
  {
    memset(_data, 0, capacity * sizeof(unsigned int));
  }
...
inline SimpleArray_UB32_1 * new_simple_array_ub32_1(INDEX capacity)
{
  return new(capacity) SimpleArray_UB32_1(capacity);
}

inline bool simple_array_ub32_1_p(Value value)
{
  return (typed_object_p(value)
          && the_typed_object(value)->widetag() == WIDETAG_SIMPLE_ARRAY_UB32_1);
}

inline SimpleArray_UB32_1 * the_simple_array_ub32_1(Value value)
{
  assert(simple_array_ub32_1_p(value));
  return reinterpret_cast<SimpleArray_UB32_1 *>(value - LOWTAG_TYPED_OBJECT);
}
